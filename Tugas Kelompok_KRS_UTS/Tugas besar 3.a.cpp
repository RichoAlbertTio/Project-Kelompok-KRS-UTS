...
struct Node
{
 string cari,nama,nim,NamaDosen,
        ubah,mk,sks,jml;
 Node* next;
};
 Node* head;
...
void Tambahdepan3A()
{
	...
	cout<<"Masukan Jumlah Mahasiswa  : "; cin>>awal->jml;
    awal->next = NULL;
    if(head==NULL)
    {
    head=tail=awal;
...
void Tambahtengah3A()
{
    ...
    if (head !=NULL)
    {
        ...
        cout<<"Masukan Nama Dosen PA     : "; cin.ignore(1, '\n'); getline(cin, baru->NamaDosen);
     	cout<<"Masukan Jumlah Mahasiswa  : "; cin>>baru->jml;
		baru->next = NULL;
		masuk2=masuk->next;
		baru->next=masuk2;
		masuk->next=baru;
...
void Tambahbelakang3A()
{
	Node *akhir;
	akhir = new Node;
	cout<<"Masukkan Data KRS di bawah ini \n";
	cout<<"Masukan Nama Dosen PA     : "; cin.ignore(1, '\n'); getline(cin, akhir->NamaDosen);
	cout<<"Masukan Jumlah Mahasiswa  : "; cin>>akhir->jml;
	akhir->next = NULL;
	if(head==NULL)
	{
    head=tail=akhir;
...
void cetak3A()
{
  ...
  if (head==NULL)
 {
  ...
  cout<<"\n====================================================================================================\n";
  cout<<"||\tNo\t||\t\tNama Dosen\t\t||\tJumlah Mahasiswa\t||\n";
  cout<<"====================================================================================================\n";
 {
  while(bantu !=NULL)
 {
...
void cari3A()
{
    ...
    cout<<"\nMenemukan Data Yang Dicari :\n\n";
	{
		while(bantu!=NULL)
	{
	if(bantu->NamaDosen==cari || bantu->jml==cari)
	{
       cout<<"\n====================================================================================================\n";
        cout<<"||\tNo\t||\t\tNama Dosen\t\t||\tJumlah Mahasiswa\t||\n";
        cout<<"====================================================================================================\n";
...
Node *bantu;
bantu = head;
cout <<"Cari Nama Dosen PA : "; fflush(stdin); getline(cin,mk);
if(head == NULL){
...
bantu = bantu ->next;
        ...
        cout<<"====================================================================================================\n";
		cout<<"\nEdit data"<<endl;
		cout<<"\nNama Dosen PA     : "; fflush(stdin);getline(cin,bantu->NamaDosen);
...
cin>>pilih;
switch(pilih){
case 1 : Tambahdepan3A();
         getch();
         break;

case 2 : Tambahtengah3A();
         getch();
         break;

case 3 : Tambahbelakang3A();
         getch();
         break;
...
case 5 : hapustengah3A();
         getch();
         break;

case 6 : Hapusbelakang3A();
         getch();
         break;
